...
body{min-width:0}main{overflow:visible}.breadcrumbs a,.search,.compact-select select,.sort-menu select,.sort-panel>summary,.scheme button,.include-links{min-height:2.75rem}
