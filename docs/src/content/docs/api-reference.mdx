...
| `outputName` | `defaultOutputName`; use `_dirwell.html` when an index exists, and skip when both names exist. A function may return a filename, `null`, or a promise of either. |
